...
const QUICK_TOUR: TourStep[] = [
  ...
  },
  {
    ...
    view: { kind: 'guns' },
    body: 'Everything else is grouped into four sets: Your Gear (guns, optics, magazines, ammo, parts, care guides), Training (drills, how the numbers work), Records (maintenance, reminders, malfunctions, costs, reports), and App & Data (Tour & Setup, Settings, Sync & Backup, Export as CSV, Import from CSV). On a phone they\'re under the More tab; on a computer they\'re down the sidebar.',
  },
  {
